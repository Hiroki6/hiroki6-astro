...
![cronos](../../assets/images/posts/cronos-writesup/cronos.png)
...
![zone_transfer](../../assets/images/posts/cronos-writesup/zone_transfer.png)
...
![cronos.htb](../../assets/images/posts/cronos-writesup/cronos_htb.png)

`gobuster` doesn't find any pages, either. 

![gobuster_cronos_htb](../../assets/images/posts/cronos-writesup/gobuster_cronos_htb.png)

Now it's time to go to `admin.cronos.htb` page. There is a login page.
It can be the initial foothold.

![admin.cronos.htb](../../assets/images/posts/cronos-writesup/admin_cronos_htb.png)

## User Flag
As the first attempt, I tries to do a basic sql injection.

![sql_injection](../../assets/images/posts/cronos-writesup/sql_injection.png)
...
![admin_page](../../assets/images/posts/cronos-writesup/admin_page.png)

Now it's time to use `Burpsuite`. I try to change the `command` parameter and make `host` parameter empty.

![burpsuite_ls](../../assets/images/posts/cronos-writesup/burpsuite_ls.png)
...
![burpsuite_ls_result](../../assets/images/posts/cronos-writesup/burpsuite_ls_result.png)
...
![burpsuite_reverse_shell](../../assets/images/posts/cronos-writesup/burpsuite_reverse_shell.png)

I get the reverse shell!

![reverse_shell](../../assets/images/posts/cronos-writesup/reverse_shell.png)
...
![spawn_tty](../../assets/images/posts/cronos-writesup/spawn_tty.png)

I'm a `www-data` user, but can read `user.txt`.

![user_txt](../../assets/images/posts/cronos-writesup/user_txt.png)
...
![crontab](../../assets/images/posts/cronos-writesup/crontab.png)

`artisan` file is a php script.

![file_artisan](../../assets/images/posts/cronos-writesup/file_artisan.png)
...
![download_artisan](../../assets/images/posts/cronos-writesup/download_artisan.png)

When the cron executes `artisan` file, I get a root shell!

![get_root](../../assets/images/posts/cronos-writesup/get_root.png)
